...
/**
 * @brief Number of beams on a given FOV ring of the scan cone.
 * @param circle_index Zero-based ring index out from the centre beam.
 * @return Beam count for that ring: 4^circle_index (1 at the centre).
 */
...
/**
 * @brief Horizontal angular offset of a beam displaced sideways from the axis.
 * @param offset Lateral displacement from the beam axis.
 * @param distance Distance along the beam axis.
 * @return atan2(offset, distance) as a HorizontalAngle.
 */
...
/**
 * @brief Vertical angular offset of a beam displaced above/below the axis.
 * @param offset Vertical displacement from the beam axis.
 * @param distance Distance along the beam axis.
 * @return atan2(offset, distance) as an AltitudeAngle.
 */
